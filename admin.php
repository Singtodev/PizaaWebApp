                ...
                while($row = $result->fetch_assoc()){
                    ...
                    <div class="w-full grid grid-cols-7 py-4 <?php echo ($i % 2 == 0 ? 'bg-white' : 'bg-gray-200'); ?>">
                            ...
                            <div class="flex flex-row gap-x-2">
                                <div class="whitespace-nowrap flex items-center justify-center cursor-pointer hover:bg-opacity-50 transition-all duration-300 bg-lime-600 px-2 text-white rounded-md"><i class="fa-solid fa-check"></i></div>
                                <a href="history_show.php?oid=<?= $row['oid'] ?>" class="h-full">
                                    <div class="whitespace-nowrap w-full h-full flex items-center justify-center cursor-pointer hover:bg-opacity-50 transition-all duration-300 bg-yellow-600 px-2 text-white rounded-md"><i class="fa-solid fa-eye"></i></div>
                                </a>
                            </div>
                    </div>
                <?php } ?>
