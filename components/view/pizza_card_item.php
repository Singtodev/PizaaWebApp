...
class PizzaCardItem {
    ...
    public function build($row) {
        ...
        echo '<div class="card w-full h-[8rem] md:h-[8rem] lg:h-[12rem] cursor-pointer bg-white bg-cover object-cover bg-center bg-no-repeat" style="background-image: url(\'' . $row['image'] . '\')"></div>';
